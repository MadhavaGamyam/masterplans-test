...
export default function LayerSelectionButton() {
  ...
  return (
    <button
      ...
      className="fixed top-6 right-6 z-40 bg-white/90 backdrop-blur-sm hover:bg-white border border-gray-300 rounded-lg px-4 py-2 shadow-lg transition-all duration-200 hover:shadow-xl flex items-center space-x-2"
    >
